    ...
    <div class="container" align="center" style="max-width: 800px">
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                <div class="container">
                    <i class="fa fa-star fa-3x star-rev" data-index="1"></i>
                    <i class="fa fa-star fa-3x star-rev" data-index="2"></i>
                    <i class="fa fa-star fa-3x star-rev" data-index="3"></i>
                    <i class="fa fa-star fa-3x star-rev" data-index="4"></i>
                    <i class="fa fa-star fa-3x star-rev" data-index="5"></i>
                </div>
...
$(document).ready(function() {
    ...
    fuction ;xhr_getter(prefix,element);{
